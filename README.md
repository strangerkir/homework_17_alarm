...
A PlatformIO-based embedded systems project for building an alarm system.

## Overview

This project implements an alarm system using PlatformIO and Arduino framework.
